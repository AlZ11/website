...
export default function Card({ children, className }: CardProps) {
	...
	return (
		...
		>
			<div className='h-full grid will-change-transform origin-center transition-transform duration-[var(--duration)] ease-[var(--easing)] delay-[var(--delay)] [transform:rotateY(var(--r-x))_rotateX(var(--r-y))] rounded-[var(--radius)] hover:[--opacity:0.1] hover:[--duration:100ms] hover:[--easing:linear] hover:filter-none overflow-hidden'>
				<div className='w-full h-full grid [grid-area:1/1] mix-blend-soft-light [clip-path:inset(0_0_0_0_round_var(--radius))] pointer-events-none'>
